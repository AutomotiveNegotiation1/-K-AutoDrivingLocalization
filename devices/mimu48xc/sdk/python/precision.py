...
d_graph = 'real time'  # Display graph  #'Real Time' or 'Off Line'
...
out_rate = float(281.25)  # Data rate (Hz) Note: Maximum supported data rate is 562.5 Hz when plot_graph is set to 0,
...
if d_graph == 'REAL TIME':
    ...
    win = pg.GraphicsWindow(title="Precision IMU")
