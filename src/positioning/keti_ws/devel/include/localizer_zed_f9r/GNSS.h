// Generated by gencpp from file localizer_zed_f9r/GNSS.msg
// DO NOT EDIT!


#ifndef LOCALIZER_ZED_F9R_MESSAGE_GNSS_H
#define LOCALIZER_ZED_F9R_MESSAGE_GNSS_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::localizer_zed_f9r::GNSS_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::localizer_zed_f9r::GNSS_<ContainerAllocator> const> ConstPtr;

}; // struct GNSS_

typedef ::localizer_zed_f9r::GNSS_<std::allocator<void> > GNSS;

typedef boost::shared_ptr< ::localizer_zed_f9r::GNSS > GNSSPtr;
typedef boost::shared_ptr< ::localizer_zed_f9r::GNSS const> GNSSConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::localizer_zed_f9r::GNSS_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::localizer_zed_f9r::GNSS_<ContainerAllocator1> & lhs, const ::localizer_zed_f9r::GNSS_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::localizer_zed_f9r::GNSS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::localizer_zed_f9r::GNSS_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::localizer_zed_f9r::GNSS_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
{
  ...
  static const char* value(const ::localizer_zed_f9r::GNSS_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x76a709426465468aULL;
  static const uint64_t static_value2 = 0x80d5b09ed58df78dULL;
};

template<class ContainerAllocator>
struct DataType< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# NavSatFix# NAV-PVT (0x01 0x07)\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::localizer_zed_f9r::GNSS_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::localizer_zed_f9r::GNSS_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // LOCALIZER_ZED_F9R_MESSAGE_GNSS_H
