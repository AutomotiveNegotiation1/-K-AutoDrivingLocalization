...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"EulerKalman_2"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString(
          (const char_T *)"C:\\Users\\zeusjang\\Downloads\\Positioning_Alg_"
                          "20231004\\EulerKalman_2.m"));
  ...
  emlrtSetField(xEntryPoints, 1, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"fusion2"));
  ...
  emlrtSetField(xEntryPoints, 1, (const char_T *)"TimeStamp",
                emlrtMxCreateDoubleScalar(739220.69445601851));
  xInputs = emlrtCreateLogicalMatrix(1, 10);
  emlrtSetField(xEntryPoints, 2, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"IMUpos"));
  ...
  emlrtSetField(xEntryPoints, 3, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"PosKalman2"));
  ...
  emlrtSetField(xEntryPoints, 4, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"UWBpos6"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString((const char_T *)"9.12.0.2327980 (R2022a) Update 7"));
  emlrtSetField(xResult, 0, (const char_T *)"ResolvedFunctions",
                (mxArray *)emlrtMexFcnResolvedFunctionsInfo());
  emlrtSetField(xResult, 0, (const char_T *)"Checksum",
                emlrtMxCreateString((const char_T *)"LZb8nieQSYA3vwXY3N9mMH"));
