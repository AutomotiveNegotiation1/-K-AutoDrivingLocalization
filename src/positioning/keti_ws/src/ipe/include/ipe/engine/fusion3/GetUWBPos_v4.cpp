...
// Return Type  : void
//
void GetUWBPos_v4(const double xa_data[], const double ya_data[],
                  const coder::array<double, 2U> &dist, double Ln,
                  const creal_T tag_pos_b[4], double *Xc, double *Yc,
                  double *heading, double *flag)
{
  ...
  if (xat.size(1) > 2) {
    TrilateralPos(xat, yat, distc, Xc, Yc);
    flagc = 1;
  } else {
    *Xc = 0.0;
    *Yc = 0.0;
  ...
  if (xas.size(1) > 2) {
    TrilateralPos(xas, yas, dists, &Xt_s_e, &Yt_s_e);
    flags = 1;
  } else {
    Xt_s_e = 0.0;
    Yt_s_e = 0.0;
  ...
  if (xae.size(1) > 2) {
    TrilateralPos(xae, yae, diste, &Xt_e_e, &Yt_e_e);
    flage = 1;
  } else {
    Xt_e_e = 0.0;
    Yt_e_e = 0.0;
  ...
  if (xaw.size(1) > 2) {
    TrilateralPos(xaw, yaw, distw, &Xt_w_e, &Yt_w_e);
    flagw = 1;
  } else {
    Xt_w_e = 0.0;
    Yt_w_e = 0.0;
  ...
  if (xan.size(1) > 2) {
    TrilateralPos(xan, yan, distn, &Xt_n_e, &Yt_n_e);
    flagn = 1;
  } else {
    Xt_n_e = 0.0;
    Yt_n_e = 0.0;
