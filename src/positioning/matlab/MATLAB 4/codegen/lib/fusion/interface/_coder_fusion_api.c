...
static void s_emlrt_marshallIn(const emlrtStack *sp, const mxArray *anchor_pos,
...
static real_T *u_emlrt_marshallIn(const emlrtStack *sp, const mxArray *RxDist,
...
static real_T *w_emlrt_marshallIn(const emlrtStack *sp, const mxArray *RxID,
...
static creal_T y_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                  const emlrtMsgIdentifier *msgId);
                               ...
                               const char_T *identifier, creal_T y[6])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  t_emlrt_marshallIn(sp, emlrtAlias(anchor_pos), &thisId, y);
                                  ...
                                  const char_T *identifier, int32_T *y_size)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y_data = v_emlrt_marshallIn(sp, emlrtAlias(RxDist), &thisId, &i);
  *y_size = i;
                                  ...
                                  int32_T *y_size)
{
  real_T *y_data;
  int32_T i;
  y_data = jb_emlrt_marshallIn(sp, emlrtAlias(u), parentId, &i);
  *y_size = i;
  emlrtDestroyArray(&u);
  return y_data;
}
                                  ...
                                  const char_T *identifier, int32_T y_size[2])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y_data = x_emlrt_marshallIn(sp, emlrtAlias(RxID), &thisId, y_size);
...
{
  real_T *y_data;
  y_data = kb_emlrt_marshallIn(sp, emlrtAlias(u), parentId, y_size);
  emlrtDestroyArray(&u);
  return y_data;
}
...
void ReliCalc_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  ...
  st.tls = emlrtRootTLSGlobal;
  /* Marshall function inputs */
  k_emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "tag_pos_est", tag_pos_est);
  s_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "anchor_pos", anchor_pos);
  *(real_T **)&RxDist_data =
      u_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "RxDist", &RxDist_size);
  *(real_T **)&RxID_data =
      w_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "RxID", RxID_size);
  PP = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "PP");
  /* Invoke the target function */
  PP = ReliCalc(tag_pos_est, anchor_pos, *RxDist_data,
                *(int32_T(*)[1]) & RxDist_size, *RxID_data, RxID_size, PP);
  /* Marshall function outputs */
  *plhs = b_emlrt_marshallOut(PP);
}
