 ...
 * File: _coder_EulerKalman_2_api.h
 *
 * MATLAB Coder version            : 5.6
 * C/C++ source code generated on  : 22-Sep-2023 10:38:00
 */

#ifndef _CODER_EULERKALMAN_2_API_H
#define _CODER_EULERKALMAN_2_API_H
...
void EulerKalman_2(real_T x[4], real_T A[16], real_T z[4], real_T *phi,
                   real_T *theta, real_T *psi);
...
void EulerKalman_2_xil_shutdown(void);

void EulerKalman_2_xil_terminate(void);

void EulerToQuaternion(real_T phi, real_T theta, real_T psi, real_T z[4]);
...
#endif
/*
 * File trailer for _coder_EulerKalman_2_api.h
 *
 * [EOF]
 */
