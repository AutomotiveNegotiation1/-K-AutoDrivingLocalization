function [cent_pos_est, cent_vel_est, kf_psi, gyro_psi, b_acc_o, b_gyro, state_o, acc_b_phi,acc_b_theta] = IMUpos(IMUacc_c, IMUgyro_c, s_time, b_acc_o, b_gyro, mode, kf_psi, gyro_psi, cent_pos_est, cent_vel_est)
...
%     [gyro_phi,gyro_theta,gyro_psi] = EulerGyroUpdate(p,q,r,dt_acc,gyro_phi,gyro_theta,gyro_psi);
    ...
    AA = eye(4)+dt_gyro*1/2*[0 -p -q -r;    p 0 r -q;    q -r 0 p;    r q -p 0    ];
    % %
