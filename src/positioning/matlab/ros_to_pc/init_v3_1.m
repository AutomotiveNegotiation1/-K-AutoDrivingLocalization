...
%% Anchor coordinates
% uwb_anchor_991B.x =  (985 - pos_offset.x)/10;
% uwb_anchor_991B.y =  (596 - pos_offset.y)/10;
% uwb_anchor_991B.z =  0.4;
% 
...
% uwb_anchor_4302.x =  0;
% uwb_anchor_4302.y =  0;
% uwb_anchor_4302.z =  0.4;
% 
% uwb_anchor_1221.x =  (833 - pos_offset.x)/10;
% uwb_anchor_1221.y =  (437 - pos_offset.y)/10;
% uwb_anchor_1221.z =  0.4;
% 
% uwb_anchor_439D.x =  (1045 - pos_offset.x)/10;
% uwb_anchor_439D.y =  (432 - pos_offset.y)/10;
% uwb_anchor_439D.z =  0.4;
% 
% uwb_anchor_89A4.x =  (839 - pos_offset.x)/10;
% uwb_anchor_89A4.y =  (652 - pos_offset.y)/10;
% uwb_anchor_89A4.z =  0.4;
% 
% uwb_anchor_4599.x =  nan;
% uwb_anchor_4599.y =  nan;
% uwb_anchor_4599.z =  nan;
% 
% uwb_anchor_9B8F.x =  (1041 - pos_offset.x)/10;
% uwb_anchor_9B8F.y =  (278 - pos_offset.y)/10;
% uwb_anchor_9B8F.z =  0.4;
...
plot(uwb_anchor_1221.x, uwb_anchor_1221.y, 'ro', 'MarkerSize',10,'LineWidth',2)
plot(uwb_anchor_991B.x, uwb_anchor_991B.y, 'bo', 'MarkerSize',10,'LineWidth',2)
plot(uwb_anchor_4302.x, uwb_anchor_4302.y, 'go', 'MarkerSize',10,'LineWidth',2)
plot(uwb_anchor_89A4.x, uwb_anchor_89A4.y, 'mo', 'MarkerSize',10,'LineWidth',2)
plot(uwb_anchor_9B8F.x, uwb_anchor_9B8F.y, 'co', 'MarkerSize',10,'LineWidth',2)
plot(uwb_anchor_1221.x, uwb_anchor_1221.y, 'ko', 'MarkerSize',10,'LineWidth',2)

% set(h, 'YDir','reverse');
% h = animatedline('MaximumNumPoints',100,'LineWidth',3,'Color','r', 'Marker','o','MarkerSize',3);
h = animatedline('LineWidth',3,'Color','r', 'Marker','o','MarkerSize',3);
% h = animatedline('LineWidth',3,'Color','r', 'Marker','o','MarkerSize',3);
% h = animatedline('LineWidth',3,'Color','r', 'Marker','o','MarkerSize',3);
% h1 = animatedline('MaximumNumPoints',1,'LineWidth',3,'Color','r', 'Marker','o','MarkerSize',5);
...
%         addpoints(h1,uwb_anchor_1221.x, uwb_anchor_1221.y, 0);
