...
%     s_time_a(lk+1) = 100000000000000000000000000;
    ...
    if min_stamp_i == 5
        ...
        [cent_pos_est, cent_vel_est, kf_psi, b_acc_o, b_gyro, state_IMU, acc_b_phi, acc_b_theta ] = IMUpos(IMUacc_c, IMUgyro_c, s_time, b_acc_o, b_gyro, 1, kf_psi, cent_pos_est, cent_vel_est);
...
figure(33);plot(TagPosTot(40+1:end),'r.')
