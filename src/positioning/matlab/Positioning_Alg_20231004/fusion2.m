function [IMUposU, b_acc_o, kf_psi, gyro_psi, cent_pos_est, cent_vel_est] = fusion2(kl,k0, tag_pos_est, tag_center_vel_est, cent_pos_est, cent_vel_est, b_acc_o, acc_b_phi, Acc_Pos, Acc_Vel, kalman_on, init_flag, UWBErrSum, kf_psi, gyro_psi, heading_est, acc_b_theta, IMUSel, Nanchor, state_IMU)
