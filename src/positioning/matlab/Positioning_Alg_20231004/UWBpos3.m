function [UWBout] = UWBpos3(Ln, Lp, LnC, TagNum, Nanchor, RxIDin, RxDistin, s_time, tag_pos_b, xain, yain)
...
%[tag_pos_est, heading_est,tag_pos_est_aver,headingest_a_aver_v]
UWBout = zeros(1,18);
UWBout(1:4) = real(tag_pos_est);
UWBout(5:8) = imag(tag_pos_est);
UWBout(9) = heading_est;
