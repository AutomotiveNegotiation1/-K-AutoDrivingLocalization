...
%         acc_b_theta_filtered = filter(LPFG2,acc_b_theta);
%         
        qua_acc = EulerToQuaternion(acc_b_phi, acc_b_theta, gyro_psi_t(i-1));
%         qua_acc_filtered = EulerToQuaternion(acc_b_phi_filtered, acc_b_theta_filtered, 0);
...
figure(1234);hold off;plot((UWB_LS_Pos(2,:)),'r');hold on;plot((UWB_M_Pos(2,:)),'b')
figure(1235);hold off;plot((UWB_M_Vel(1,:)),'r');hold on;plot((UWB_M_Vel(2,:)),'b');plot(UWB_M_Vel(3,:),'g')
