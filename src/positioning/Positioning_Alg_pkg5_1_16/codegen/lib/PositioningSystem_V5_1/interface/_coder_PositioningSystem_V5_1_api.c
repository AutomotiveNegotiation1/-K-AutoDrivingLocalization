...
static real_T *e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                  ...
                                  int32_T ret_size[2])
{
  static const int32_T dims[2] = {1, 92};
  real_T *ret_data;
  int32_T iv[2];
...
void PositioningSystem_V5_1_api(const mxArray *const prhs[2],
                                const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
  ...
  *(real_T **)&PositionVector_data = emlrt_marshallIn(
      &st, emlrtAlias(prhs[0]), "PositionVector", PositionVector_size);
  MapParam = c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "MapParam");
  /* Invoke the target function */
  PositioningSystem_V5_1(*PositionVector_data, PositionVector_size, *MapParam,
                         *PositionOut);
