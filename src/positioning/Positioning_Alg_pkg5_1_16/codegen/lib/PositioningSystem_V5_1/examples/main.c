...
static void argInit_1xd92_real_T(double result_data[], int result_size[2]);
...
void main_PositioningSystem_V5_1(void)
{
  ...
  argInit_1xd92_real_T(PositionVector_data, PositionVector_size);
  /* Initialize function input argument 'MapParam'. */
  /* Call the entry-point 'PositioningSystem_V5_1'. */
  argInit_1x16_real_T(dv);
  PositioningSystem_V5_1(PositionVector_data, PositionVector_size, dv,
                         PositionOut);
}
