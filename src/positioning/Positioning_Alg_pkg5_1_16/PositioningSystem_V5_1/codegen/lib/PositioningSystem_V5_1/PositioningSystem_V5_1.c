...
void PositioningSystem_V5_1_init(void)
{
  static const double dv[9] = {
      8.98678546984569,  -3.29350190352921,  -0.786554698253246,
      -3.16286289578914, -0.322384631930764, -0.0117270025358505,
      11.388730267812,   -4.20191306534414,  0.61740925168584};
  int k;
  yt_b.size[1] = 0;
  xt_b.size[1] = 0;
  s_time_vec[0] = 0.0;
