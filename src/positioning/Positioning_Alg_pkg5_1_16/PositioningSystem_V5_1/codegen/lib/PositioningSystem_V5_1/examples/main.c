...
static void argInit_1xd89_real_T(double result_data[], int result_size[2]);
...
void main_PositioningSystem_V5_1(void)
{
  ...
  argInit_1xd89_real_T(PositionVector_data, PositionVector_size);
