...
void PositioningSystem_V5_1_init(void)
{
  static const double dv[9] = {
      -0.179076323425308, 4.63906340795275,      0.0216411203109203,
      -4.70176976705236,  -0.000199387461002719, 0.0277307453847892,
      0.134342131184567,  -0.100451165151223,    0.999381142343647};
  int k;
  yt_b.size[1] = 0;
  xt_b.size[1] = 0;
  s_time_vec[0] = 0.0;
  ...
  /*  pitch = 4.7222; */
  /*  yaw = 0.0056; */
  /*  sA= [-0.0777   -7.8266    0.;    7.9348    0.3640    0.0367;   -0.0056
   * 0.0206    0.9998]; */
  /*  SLAMposInit = [3.3622;   79.4956;         0]; */
  /*  s = 4.8184; */
  /*  roll = 0.0170; */
  /*  pitch = 4.7258; */
  /*  yaw = -0.0016; */
  /*  sA= [   -0.0649   -4.7709    0.0814;    4.8244    0.0379   -0.0084; 0.0016
   * 0.0170    0.9999]; */
  /*  SLAMposInit = [4.0302;   79.0227;         0]; */
  /* sA= [8.98678546984569
   * -3.16286289578914	11.3887302678120;-3.29350190352921	-0.322384631930764
   * -4.20191306534414 ;-0.786554698253246	-0.0117270025358505
   * 0.617409251685840    ]; */
  /* sA = [-0.0350707290031734	-3.70091678334717	0.0455958687897919
   * ;3.65058165985410	0.100829809456733	-0.0801278893229746;
   * 0.0216080882873477	0.0121116115363106	0.999693152615621]; */
  memcpy(&sA[0], &dv[0], 9U * sizeof(double));
  SLAMposInit[0] = 2.7476;
  SLAMposInit[1] = 77.4887;
  SLAMposInit[2] = 0.0;
}
