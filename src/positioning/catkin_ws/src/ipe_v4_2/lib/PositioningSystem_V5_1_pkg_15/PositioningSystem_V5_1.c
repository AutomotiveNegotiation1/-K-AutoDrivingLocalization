...
void PositioningSystem_V5_1_init(void)
{
  static const double dv[9] = {
      -0.0350707290031734, 3.6505816598541,     0.0216080882873477,
      -3.70091678334717,   0.100829809456733,   0.0121116115363106,
      0.0455958687897919,  -0.0801278893229746, 0.999693152615621};
  int k;
  yt_b.size[1] = 0;
  xt_b.size[1] = 0;
  s_time_vec[0] = 0.0;
  ...
  SLAMposInit[0] = 3.9997;
  SLAMposInit[1] = 77.71231;
  SLAMposInit[2] = 0.0;
}
