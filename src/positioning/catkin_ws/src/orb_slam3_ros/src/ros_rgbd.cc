...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> sub_rgb_img(node_handler, "/zed2/zed_node/right/image_rect_color", 100);

    //message_filters::Subscriber<sensor_msgs::Image> sub_depth_img(node_handler, "/camera/depth_registered/image_raw", 100);
    message_filters::Subscriber<sensor_msgs::Image> sub_depth_img(node_handler, "/zed2/zed_node/depth/depth_registered", 100);
