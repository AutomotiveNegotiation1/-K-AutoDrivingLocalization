...
(cl:in-package localizer_zed_f9r-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <GNSS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GNSS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localizer_zed_f9r-msg:<GNSS> is deprecated: use localizer_zed_f9r-msg:GNSS instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:header-val is deprecated.  Use localizer_zed_f9r-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'iTOW-val :lambda-list '(m))
(cl:defmethod iTOW-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:iTOW-val is deprecated.  Use localizer_zed_f9r-msg:iTOW instead.")
  (iTOW m))

(cl:ensure-generic-function 'year-val :lambda-list '(m))
(cl:defmethod year-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:year-val is deprecated.  Use localizer_zed_f9r-msg:year instead.")
  (year m))

(cl:ensure-generic-function 'month-val :lambda-list '(m))
(cl:defmethod month-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:month-val is deprecated.  Use localizer_zed_f9r-msg:month instead.")
  (month m))

(cl:ensure-generic-function 'day-val :lambda-list '(m))
(cl:defmethod day-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:day-val is deprecated.  Use localizer_zed_f9r-msg:day instead.")
  (day m))

(cl:ensure-generic-function 'hour-val :lambda-list '(m))
(cl:defmethod hour-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:hour-val is deprecated.  Use localizer_zed_f9r-msg:hour instead.")
  (hour m))

(cl:ensure-generic-function 'min-val :lambda-list '(m))
(cl:defmethod min-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:min-val is deprecated.  Use localizer_zed_f9r-msg:min instead.")
  (min m))

(cl:ensure-generic-function 'sec-val :lambda-list '(m))
(cl:defmethod sec-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:sec-val is deprecated.  Use localizer_zed_f9r-msg:sec instead.")
  (sec m))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:valid-val is deprecated.  Use localizer_zed_f9r-msg:valid instead.")
  (valid m))

(cl:ensure-generic-function 'tAcc-val :lambda-list '(m))
(cl:defmethod tAcc-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:tAcc-val is deprecated.  Use localizer_zed_f9r-msg:tAcc instead.")
  (tAcc m))

(cl:ensure-generic-function 'nano-val :lambda-list '(m))
(cl:defmethod nano-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:nano-val is deprecated.  Use localizer_zed_f9r-msg:nano instead.")
  (nano m))

(cl:ensure-generic-function 'fixType-val :lambda-list '(m))
(cl:defmethod fixType-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:fixType-val is deprecated.  Use localizer_zed_f9r-msg:fixType instead.")
  (fixType m))

(cl:ensure-generic-function 'flags-val :lambda-list '(m))
(cl:defmethod flags-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:flags-val is deprecated.  Use localizer_zed_f9r-msg:flags instead.")
  (flags m))

(cl:ensure-generic-function 'flags2-val :lambda-list '(m))
(cl:defmethod flags2-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:flags2-val is deprecated.  Use localizer_zed_f9r-msg:flags2 instead.")
  (flags2 m))

(cl:ensure-generic-function 'numSV-val :lambda-list '(m))
(cl:defmethod numSV-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:numSV-val is deprecated.  Use localizer_zed_f9r-msg:numSV instead.")
  (numSV m))

(cl:ensure-generic-function 'lon-val :lambda-list '(m))
(cl:defmethod lon-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:lon-val is deprecated.  Use localizer_zed_f9r-msg:lon instead.")
  (lon m))

(cl:ensure-generic-function 'lat-val :lambda-list '(m))
(cl:defmethod lat-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:lat-val is deprecated.  Use localizer_zed_f9r-msg:lat instead.")
  (lat m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:height-val is deprecated.  Use localizer_zed_f9r-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'hMSL-val :lambda-list '(m))
(cl:defmethod hMSL-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:hMSL-val is deprecated.  Use localizer_zed_f9r-msg:hMSL instead.")
  (hMSL m))

(cl:ensure-generic-function 'hAcc-val :lambda-list '(m))
(cl:defmethod hAcc-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:hAcc-val is deprecated.  Use localizer_zed_f9r-msg:hAcc instead.")
  (hAcc m))

(cl:ensure-generic-function 'vAcc-val :lambda-list '(m))
(cl:defmethod vAcc-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:vAcc-val is deprecated.  Use localizer_zed_f9r-msg:vAcc instead.")
  (vAcc m))

(cl:ensure-generic-function 'velN-val :lambda-list '(m))
(cl:defmethod velN-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:velN-val is deprecated.  Use localizer_zed_f9r-msg:velN instead.")
  (velN m))

(cl:ensure-generic-function 'velE-val :lambda-list '(m))
(cl:defmethod velE-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:velE-val is deprecated.  Use localizer_zed_f9r-msg:velE instead.")
  (velE m))

(cl:ensure-generic-function 'velD-val :lambda-list '(m))
(cl:defmethod velD-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:velD-val is deprecated.  Use localizer_zed_f9r-msg:velD instead.")
  (velD m))

(cl:ensure-generic-function 'gSpeed-val :lambda-list '(m))
(cl:defmethod gSpeed-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:gSpeed-val is deprecated.  Use localizer_zed_f9r-msg:gSpeed instead.")
  (gSpeed m))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:heading-val is deprecated.  Use localizer_zed_f9r-msg:heading instead.")
  (heading m))

(cl:ensure-generic-function 'sAcc-val :lambda-list '(m))
(cl:defmethod sAcc-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:sAcc-val is deprecated.  Use localizer_zed_f9r-msg:sAcc instead.")
  (sAcc m))

(cl:ensure-generic-function 'headAcc-val :lambda-list '(m))
(cl:defmethod headAcc-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:headAcc-val is deprecated.  Use localizer_zed_f9r-msg:headAcc instead.")
  (headAcc m))

(cl:ensure-generic-function 'pDOP-val :lambda-list '(m))
(cl:defmethod pDOP-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:pDOP-val is deprecated.  Use localizer_zed_f9r-msg:pDOP instead.")
  (pDOP m))

(cl:ensure-generic-function 'reserved1-val :lambda-list '(m))
(cl:defmethod reserved1-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:reserved1-val is deprecated.  Use localizer_zed_f9r-msg:reserved1 instead.")
  (reserved1 m))

(cl:ensure-generic-function 'headVeh-val :lambda-list '(m))
(cl:defmethod headVeh-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:headVeh-val is deprecated.  Use localizer_zed_f9r-msg:headVeh instead.")
  (headVeh m))

(cl:ensure-generic-function 'magDec-val :lambda-list '(m))
(cl:defmethod magDec-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:magDec-val is deprecated.  Use localizer_zed_f9r-msg:magDec instead.")
  (magDec m))

(cl:ensure-generic-function 'magAcc-val :lambda-list '(m))
(cl:defmethod magAcc-val ((m <GNSS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localizer_zed_f9r-msg:magAcc-val is deprecated.  Use localizer_zed_f9r-msg:magAcc instead.")
  (magAcc m))
